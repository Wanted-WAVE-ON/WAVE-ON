...
CREATE TABLE contexts (
    ...
    activity TEXT NOT NULL CHECK (activity IN ('presentation','music','browser','other')),
...
CREATE TABLE gesture_patterns (
    ...
    context_scope TEXT NOT NULL CHECK (context_scope IN ('presentation','music','browser','other')),
    target TEXT NOT NULL,
